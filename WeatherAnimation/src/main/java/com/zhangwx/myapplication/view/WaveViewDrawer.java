...
public class WaveViewDrawer {
     ...
     * 但高于一定限度后人眼察觉不出。
     */
    private static final int SAMPLING_SIZE = 104;
    /**
     * 采样点的X
     */
    ...
    public void drawWave(Canvas canvas,long millisPassed) {
        canvas.save();
    ...
    private void onRender(Canvas canvas, long millisPassed) {
